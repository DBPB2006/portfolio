...
const WhatIDo = () => {
    return (
        <div className="w-full relative opacity-0-init animate-fade-in-up animate-delay-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Capability 1 */}
                <div className="p-8 bg-white/50 border border-[var(--color-border)] hover:border-[var(--color-text-bright)] hover:shadow-[4px_4px_0px_var(--color-text-bright)] transition-all group">
